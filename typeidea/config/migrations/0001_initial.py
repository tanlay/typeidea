# Generated by Django 2.2.13 on 2021-02-05 14:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(0, '展示'), (1, '隐藏')], default=0, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('updated_time', models.DateTimeField(auto_created=True, verbose_name='修改时间')),
                ('title', models.CharField(max_length=50, verbose_name='标题')),
